...
Route::prefix('administrasi-umum')->name('administrasi-umum.')->middleware(['auth', AdministrasiUmumMiddleware::class])->group(function () {
    // Dashboard Routes
    Route::get('/dashboard', [App\Http\Controllers\AdministrasiUmum\DashboardController::class, 'index'])->name('dashboard');
    Route::get('/dashboard/stats', [App\Http\Controllers\AdministrasiUmum\DashboardController::class, 'getStats'])->name('dashboard.stats');
    
    // Order Perbaikan Routes - Admin only manages existing orders
    Route::prefix('order-perbaikan')->name('order-perbaikan.')->group(function () {
        Route::get('/', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'index'])->name('index');
        Route::get('/urgent', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'urgent'])->name('urgent');
        Route::get('/segera', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'segera'])->name('segera');
        Route::get('/biasa', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'biasa'])->name('biasa');
        Route::get('/pending', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'pending'])->name('pending');
        Route::get('/rejected', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'rejected'])->name('rejected');
        Route::get('/confirmed', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'confirmed'])->name('confirmed');
        Route::get('/{orderPerbaikan}', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'show'])->name('show');
        Route::put('/{orderPerbaikan}/status', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'updateStatus'])->name('update-status');
        Route::get('/export', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'export'])->name('export');
        Route::post('/{orderPerbaikan}/approve', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'approve'])->name('approve');
        Route::post('/{orderPerbaikan}/reject', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'reject'])->name('reject');
        Route::post('/{orderPerbaikan}/complete', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'complete'])->name('complete');
        Route::post('/{orderPerbaikan}/start', [App\Http\Controllers\AdministrasiUmum\OrderPerbaikanController::class, 'start'])->name('start');
    });
