                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="unit_proses" id="unit_proses" 
                            ...
                            @foreach($departments as $dept)
                                <option value="{{ $dept->id }}" {{ old('unit_proses', $orderPerbaikan->unit_proses) == $dept->id ? 'selected' : '' }}>
                                    {{ $dept->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="unit_penerima" id="unit_penerima" 
                            ...
                            @foreach($departments as $dept)
                                <option value="{{ $dept->id }}" {{ old('unit_penerima', $orderPerbaikan->unit_penerima) == $dept->id ? 'selected' : '' }}>
                                    {{ $dept->name }}
                                </option>
                            @endforeach
                        </select>
                ...
                <div>
                    <div class="mb-4">
                        ...
                        <select name="jenis_barang" id="jenis_barang" 
                            ...
                            <option value="Non-Inventaris" {{ old('jenis_barang', $orderPerbaikan->jenis_barang) == 'Non-Inventaris' ? 'selected' : '' }}>Non-Inventaris</option>
                        </select>
                        @error('jenis_barang')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="mb-4">
                        ...
                        <select name="prioritas" id="prioritas" 
                            ...
                            required>
                            <option value="BIASA" {{ old('prioritas', $orderPerbaikan->prioritas) == 'BIASA' ? 'selected' : '' }}>BIASA</option>
                            <option value="SEGERA" {{ old('prioritas', $orderPerbaikan->prioritas) == 'SEGERA' ? 'selected' : '' }}>SEGERA</option>
                            <option value="URGENT" {{ old('prioritas', $orderPerbaikan->prioritas) == 'URGENT' ? 'selected' : '' }}>URGENT</option>
                        </select>
                        @error('prioritas')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                        @enderror
