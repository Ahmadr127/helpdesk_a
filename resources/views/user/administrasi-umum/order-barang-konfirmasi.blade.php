    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="mb-6 bg-white rounded-lg p-6 shadow-sm">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Permintaan Barang - Konfirmasi</h1>
                    <p class="mt-2 text-sm text-gray-600">Daftar permintaan barang yang telah dikonfirmasi</p>
                </div>
