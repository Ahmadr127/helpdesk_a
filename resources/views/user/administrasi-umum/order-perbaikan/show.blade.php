            ...
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    ...
                    <button onclick="confirmDelete('{{ $order->id }}')"
                        class="inline-flex items-center px-3 py-1.5 bg-red-500 hover:bg-red-600 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-white text-sm font-medium rounded-md cursor-pointer">
                    ...
                    <a href="{{ route('user.administrasi-umum.order-perbaikan.edit', $order) }}"
                        class="inline-flex items-center px-3 py-1.5 bg-blue-500 hover:bg-blue-600 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-white text-sm font-medium rounded-md cursor-pointer">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <a href="{{ route('user.administrasi-umum.order-barang') }}"
                        class="inline-flex items-center px-3 py-1.5 bg-green-500 hover:bg-green-700 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 text-white text-sm font-medium rounded-md cursor-pointer">
                        <svg class="w-4 h-4 mr-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
