...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-5xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold mb-6">Buat Tiket Dukungan Baru</h2>
            ...
            <form action="{{ route('user.ticket.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                        ...
                        <select name="building_id" id="building_id" onchange="updateLocations()"
                            class="w-full px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-[#e8f5e9] focus:border-[#2e7d32] transition-colors"
                            required>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-xs text-gray-500">Ukuran file maksimum: 5MB</p>
                        @error('photo')
...
// Initialize locations on page load if building is already selected
