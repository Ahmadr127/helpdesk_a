...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6 flex items-center justify-between">
        ...
        <button onclick="openModal()" class="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-4 py-2 rounded-lg hover:from-blue-600 hover:to-blue-700 transition-all shadow-md">
            Add Category
        </button>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6 border border-gray-100">
        <form action="{{ route('admin.master.categories.index') }}" method="GET"
