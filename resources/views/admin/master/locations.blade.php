...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6 border border-gray-100">
        <form action="{{ route('admin.master.locations.index') }}" method="GET"
            ...
            <div>
                ...
                <select name="building_id" class="w-full rounded-md border-gray-300 focus:border-blue-500 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
