...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden border border-gray-100 mb-8">
        ...
        <div class="p-6">
            <form action="{{ route('admin.tickets.history.index') }}" method="GET" class="mb-6 bg-gray-50 p-4 rounded-lg">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    <thead class="bg-gradient-to-r from-gray-50 to-gray-100">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Waktu Proses</th>
                            <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Dikonfirmasi Pada</th>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ ucfirst($ticket->category) }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $ticket->user_confirmed_at->format('d M Y H:i') }}</td>
                        ...
                        @empty
                        <tr>
                            <td colspan="7" class="px-6 py-4 text-center text-sm text-gray-500">Tidak ada riwayat tiket ditemukan</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
