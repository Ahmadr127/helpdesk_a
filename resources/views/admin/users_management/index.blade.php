...
<div class="card bg-white shadow-md rounded-xl overflow-hidden">
    <div class="card-header flex justify-between items-center">
        ...
        <a href="{{ route('admin.users.create') }}"
            class="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white px-4 py-2 rounded-lg shadow-sm transition-all duration-300 flex items-center">
                ...
                <thead class="bg-gradient-to-r from-green-50 to-blue-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                            Position</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">Role
                        </th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
                            Department</th>
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 uppercase tracking-wider">
