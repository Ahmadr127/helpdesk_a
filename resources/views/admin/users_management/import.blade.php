...
<div class="max-w-4xl mx-auto">
    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 bg-white border-b border-gray-200">
            ...
            <div class="mb-6 p-4 bg-gray-50 border border-gray-200 rounded-lg">
                ...
                <div class="mt-3 text-sm text-gray-600">
                    ...
                    <ul class="list-disc list-inside space-y-1">
                        ...
                        <li>User baru akan otomatis diberikan role <strong>user</strong></li>
                        <li>Password default import untuk semua user: <code class="bg-gray-200 px-2 py-1 rounded">rsazra</code></li>
            ...
            <!-- Upload Form -->
            <form action="{{ route('admin.users.import.process') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="importForm" novalidate>
                @csrf
